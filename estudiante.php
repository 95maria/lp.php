...
public function mostrarEstudiante():String{
    $menaje = null;
    try{
        $dsn = "mysql:host=localhost;dbname=udh";
        $usuario = "root";
        ...
        $numRows = $respuesta->rowCount();
        if($numRows!=0){
            $mensaje = "<p>Se han mostrado los datos</p>";
        }else{
            $mensaje = "<p>Hubo un error, no se mostro</p>";
        }
    }
    catch(PDOexception $e){
        $mensaje = $e->getMessage();
...
public function actualizarEstudiante():String{
    $mensaje= null;
    ...
    try{
        ...
        $numRows = $respuesta->rowCount();
        if($numRows!=0){
            $mensaje = "<p>Se han actualzado los datos los datos</p>";
        }else{
            $mensaje = "<p>Hubo un error, no se atualizo</p>";
        }
    }
    catch(PDOexception $e){
        $mensaje = $e->getMessage();
...
public function eliminarEstudiante():String{
    $mensaje= null;
    ...
    try{
        ...
        $numRows = $respuesta->rowCount();
        if($numRows!=0){
            $mensaje = "<p>Se han eliminado los datos los datos</p>";
        }else{
            $mensaje = "<p>Hubo un error, no se elimino/p>";
        }
    }
    catch(PDOexception $e){
        $mensaje = $e->getMessage();
